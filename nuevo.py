...
def show_initials_input_menu(surface, score, music_manager, on_return):
    ...
    initials_input = menu.add.text_input('Iniciales: ', maxchar=3, input_type=pygame_menu.locals.INPUT_TEXT, input_underline='_')
    error_label = None
    ...
    def save_initials_and_return():
        ...
        try:
            ...
            print(f"Iniciales y puntuación guardadas: {initials}, {score}")
            menu.disable()
    ...
    menu.add.label(f"Puntuación: {score}", font_size=32)
